        ...
        <div className="container mx-auto px-1 md:px-4 py-3 md:py-4">
          ...
          <div className="flex items-center justify-between gap-4 mb-3">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <img src={acctLogo} alt="ACCT Accredited Vendor" className="h-12 md:h-[4.5rem] w-auto object-contain" />
            </div>
          ...
          <div className="rounded-lg bg-background/40 backdrop-blur-sm">
            <div className="container mx-auto px-2 md:px-4 py-16">
              ...
              <div className="flex flex-wrap justify-center gap-6 max-w-6xl mx-auto">
                ...
                <Card 
                  className="flex-1 min-w-[280px] max-w-[400px] relative overflow-visible glass-panel-strong hover:shadow-2xl transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-400/60 cursor-pointer group"
                  onClick={() => {
                ...
                <Card 
                  className="flex-1 min-w-[280px] max-w-[400px] relative overflow-visible glass-panel-strong hover:shadow-2xl transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-400/60 cursor-pointer group"
                  onClick={() => {
                    triggerHaptic('light');
                ...
                <Card 
                  className="flex-1 min-w-[280px] max-w-[400px] relative overflow-visible glass-panel-strong hover:shadow-2xl transition-all duration-300 hover:-translate-y-0.5 hover:border-violet-400/60 cursor-pointer group"
                  onClick={() => {
                    triggerHaptic('light');
                ...
                {isLovablePreview() && (
                <Card
                  className="flex-1 min-w-[280px] max-w-[400px] relative overflow-visible glass-panel-strong hover:shadow-2xl transition-all duration-300 hover:-translate-y-0.5 hover:border-orange-400/60 cursor-pointer group"
                  onClick={() => {
                    triggerHaptic('light');
                    navigate("/jcf/new");
                  }}
