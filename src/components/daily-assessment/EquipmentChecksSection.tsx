...
const EQUIPMENT_ITEMS = [
  ...
  { key: 'carabiners', label: 'Carabiners' },
  { key: 'belay_devices', label: 'Belay devices' },
  { key: 'helmets', label: 'Helmets' },
  { key: 'ropes', label: 'Ropes' },
  { key: 'pulleys', label: 'Pulleys' },
  { key: 'rescue_kit', label: 'Rescue kit' },
];
...
export default function EquipmentChecksSection({ checks, onUpdate }: EquipmentChecksSectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Pre-Use Equipment Inspection</CardTitle>
      </CardHeader>
