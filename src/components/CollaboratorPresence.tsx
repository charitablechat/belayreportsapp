...
export function CollaboratorPresence({
  ...
  return (
    <div
      className="flex items-center gap-2 rounded-md border border-amber-300/60 bg-amber-50 dark:bg-amber-950/30 dark:border-amber-700/60 px-3 py-2 text-sm text-amber-800 dark:text-amber-200"
      role="status"
      aria-live="polite"
    >
